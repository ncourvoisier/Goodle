...
=======
				echo '<a href="modif_evenement?event=' . $_GET['event'] . '"><button name="btnModifier">Modifier</button></a>&emsp;';
				echo '<a href="evenement.php?remove_event=' . $_GET['event'] . '"><button name="btnSupprimerEvent">Supprimer</button></a>';
>>>>>>> d9edd75374ce3d83370b3f28f34a9acf48528232
